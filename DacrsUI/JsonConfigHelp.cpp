...
void CJsonConfigHelp::ReadJsonConfig(const CString& strFilePath)
{
	...
	if (reader.parse(ifs, root,false))
	{
		...
		if (pos > 0)
		{
			...
			::MessageBox( NULL , _T("script Î´ÅäÖÃ") , "Error" , MB_ICONERROR) ;
			exit(0);
		}
		...
		if (pos >0)
		{
			...
			::MessageBox( NULL , _T("darkcoin Î´ÅäÖÃ") , "Error" , MB_ICONERROR) ;
			exit(0);
		}
		...
		if (pos > 0)
		{
			...
			::MessageBox( NULL , _T("p2pbet Î´ÅäÖÃ") , "Error" , MB_ICONERROR) ;
			exit(0);
		}
		...
		if (pos > 0)
		{
			...
			::MessageBox( NULL , _T("netparam Î´ÅäÖÃ") , "Error" , MB_ICONERROR) ;
			exit(0);
		}
		...
		if (pos >0)
		{
			...
			::MessageBox( NULL , _T("logcfg Î´ÅäÖÃ") , "Error" , MB_ICONERROR) ;
			exit(0);
		}
